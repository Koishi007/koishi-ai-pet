...
_KEY_META = {
    ...
    "MOOD_JOY_DECAY_PER_TICK":   {"type": "float",    "default": 1.5,           "category": "behavior",   "needs_restart": False, "hidden": False, "description": "愉悦度每 tick 回归速率(点/300秒)"},
    ...
    "MOOD_AFFECTION_DECAY_PER_TICK": {"type": "float","default": 0.8,           "category": "behavior",   "needs_restart": False, "hidden": False, "description": "好感度每 tick 回归速率(点/300秒)"},
    "MOOD_GRACE_SECONDS":        {"type": "int",      "default": 600,           "category": "behavior",   "needs_restart": False, "hidden": True,  "description": "互动后免衰减秒数（防抖，避免刚被哄好又回落）"},
