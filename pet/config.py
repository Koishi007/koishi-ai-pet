...
_KEY_META = {
    ...
    "LLM_CREATE_TIMEOUT":        {"type": "float",    "default": 30,            "category": "connection", "needs_restart": False, "hidden": False, "description": "建流超时(秒)：等待响应头超过该时长即放弃，避免服务端无响应时卡死"},
    ...
    "MOOD_AFFECTION_BASELINE":   {"type": "float",    "default": 60.0,          "category": "behavior",   "needs_restart": False, "hidden": False, "description": "好感度回归基线，长期疏远会缓慢回落到此值"},
    "MOOD_AFFECTION_DECAY_PER_TICK": {"type": "float","default": 0.4,           "category": "behavior",   "needs_restart": False, "hidden": False, "description": "好感度每 tick 回归速率(点/300秒)"},
    "MOOD_GRACE_SECONDS":        {"type": "int",      "default": 60,            "category": "behavior",   "needs_restart": False, "hidden": True,  "description": "互动后免衰减秒数（防抖，避免刚被哄好又回落）"},
    ...
    "MEMORY_RECALL_COUNT":       {"type": "int",      "default": 15,             "category": "memory",   "needs_restart": False, "hidden": False, "description": "每次对话召回的记忆条数"},
